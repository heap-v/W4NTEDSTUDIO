...
game:GetService("UserInputService").InputBegan:connect(function(v)
    if v.KeyCode == Enum.KeyCode.RightShift and game:GetService("CoreGui"):FindFirstChild("〔WantedStudio〕") then
        game:GetService("CoreGui")["〔WantedStudio〕"].Enabled = not game:GetService("CoreGui")["〔WantedStudio〕"].Enabled 
        end
    end)
return library
